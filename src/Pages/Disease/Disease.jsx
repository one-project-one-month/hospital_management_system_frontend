  ...
  return (
    <>
      <Card>
        ...
        <CardContent>
          <form
            className="mx-auto flex items-center justify-center flex-col mt-8"
            onSubmit={handelAdd}
          >
            <div>
              ...
              <input
                type="submit"
                value="Submit"
                className="px-2 py-1 bg-blue-400 w-[100%] m-4 cursor-pointer rounded-md"
              />
            </div>
          </form>
    ...
    {error && <h1>Something went wrong</h1>} */}
          <div className="flex px-4 items-center m-4">
            ...
            <input
              type="text"
              placeholder="Search..."
              className="border ml-4 w-[300px] px-2 py-1 rounded-md dark:text-black"
      ...
      <TableCell className="text-right"> <Button>Edit</Button> <Button>Delete</Button></TableCell>
          ...
          >
            <div className="pagination">
              <Link
                to="../"
                className={buttonVariants({ variant: "bg-blue-400" })}
              >
                Back
              </Link>
              <button
